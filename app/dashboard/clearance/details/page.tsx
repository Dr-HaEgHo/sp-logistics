...
import { DropDownFade, FileInputFade, FileInputFade2, PreviewFileInputFade, TextArea } from "@/components/Input";
...
const Page = () => {
    ...
    const { openDoc, setOpenDoc, openAction, setOpenAction } = useContext(GlobalContext);
        ...
        <div className="w-[840px] min-w-[840px] min-h-[400px] max-h-[90vh] slim-scroll bg-white relative">
          ...
          <div className="px-10 pt-4 bg-white flex gap-[26px]">
            ...
            <div className="w-full input-wrap">
                <label className="labelsFade text-grey900">Images/Attachments</label>
            ...
            <div className="w-full">
                <button className="w-fit h-9  bg-success rounded flex hover:bg-successHover transition duration-200">
                    <div className="w-[126px] h-full px-7 flex items-center justify-center">
                        <p className="text-xs font-semibold text-grey1000">Low Priority</p>
                    </div>
          ...
          <div className="px-10 pt-6 w-full grid grid-cols-2 gap-10">
            ...
            <div className="w-full flex items-center gap-[10px]">
                <Image
                    ...
                    className="w-8 h-8"
                />
                <p className="text-[13px] text-dark600 leading-4">Note: Some statuses cannot be updated unless a <br /> specific document is uploaded</p>
            </div>
